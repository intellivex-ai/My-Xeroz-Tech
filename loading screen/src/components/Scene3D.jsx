...
function Model({ onProgressUpdate, pointLightRef }) {
...
export default function Scene3D({ onProgressUpdate }) {
  ...
  return (
    ...
    >
      ...
      <Suspense fallback={null}>
        <Model onProgressUpdate={onProgressUpdate} pointLightRef={pointLightRef} />
